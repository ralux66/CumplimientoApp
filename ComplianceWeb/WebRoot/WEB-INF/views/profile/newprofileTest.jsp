...
<meta charset="utf-8" />
<title>Keen | Basic Forms</title>
<meta name="description" content="Basic form examples">
<meta name="viewport"
...
<link
	href="${urlPublic}/assets/vendors/general/tether/dist/css/tether.css"
	rel="stylesheet" type="text/css" />
<link
...
<link
	...
	rel="stylesheet" type="text/css" />
<link
	href="${urlPublic}/assets/vendors/general/dropzone/dist/dropzone.css"
	rel="stylesheet" type="text/css" />
<link
	href="${urlPublic}/assets/vendors/general/summernote/dist/summernote.css"
	rel="stylesheet" type="text/css" />
<link
...
<link href="${urlPublic}/assets/vendors/general/morris.js/morris.css"
	rel="stylesheet" type="text/css" />
<link
	href="${urlPublic}/assets/vendors/general/sweetalert2/dist/sweetalert2.css"
	rel="stylesheet" type="text/css" />
...
<link
	...
	rel="stylesheet" type="text/css" />
<link
	href="${urlPublic}/assets/vendors/custom/vendors/flaticon/flaticon.css"
	rel="stylesheet" type="text/css" />
<link
	href="${urlPublic}/assets/vendors/custom/vendors/flaticon2/flaticon.css"
	rel="stylesheet" type="text/css" />
<link
...
<!--begin::Layout Skins -->
<link
	href="${urlPublic}/assets/demo/default/skins/header/base/light.css"
	rel="stylesheet" type="text/css" />
<link
	href="${urlPublic}/assets/demo/default/skins/header/menu/light.css"
	rel="stylesheet" type="text/css" />
...
<link rel="shortcut icon"
	href="${urlPublic}/assets/media/logos/favicon.ico" />
</head>
...
<body
								...
								<div class="k-menu__submenu ">
									...
									<ul class="k-menu__subnav">
										...
										<li class="k-menu__item " aria-haspopup="true"><a
											href="index.html" class="k-menu__link "><i
								...
								<ul class="k-nav k-margin-t-10 k-margin-b-10">
									<li class="k-nav__item k-nav__item--active"><a href="#"
										class="k-nav__link"> <span class="k-nav__link-icon"><img
												src="${urlPublic}/assets/media/flags/020-flag.svg" alt="" /></span>
											<span class="k-nav__link-text">English</span>
									</a></li>
									<li class="k-nav__item"><a href="#" class="k-nav__link">
											<span class="k-nav__link-icon"><img
												src="${urlPublic}/assets/media/flags/016-spain.svg" alt="" /></span>
											<span class="k-nav__link-text">Spanish</span>
									</a></li>
									<li class="k-nav__item"><a href="#" class="k-nav__link">
											<span class="k-nav__link-icon"><img
												src="${urlPublic}/assets/media/flags/017-germany.svg" alt="" /></span>
								...
								<div
									...
									<div class="k-user-card__wrapper">
										<div class="k-user-card__pic">
											<img alt="Pic"
												src="${urlPublic}/assets/media/users/300_21.jpg" />
										</div>
				...
				<div
					...
					<div class="k-content__head	k-grid__item">
						<div class="k-content__head-main">
							<h3 class="k-content__head-title">Basic Forms</h3>
							<div class="k-content__head-breadcrumbs">
								<a href="#" class="k-content__head-breadcrumb-home"><i
									...
									class="k-content__head-breadcrumb-link">Extended</a> <span
									class="k-content__head-breadcrumb-separator"></span> <a href=""
									class="k-content__head-breadcrumb-link">Forms</a> <span
									class="k-content__head-breadcrumb-separator"></span> <a href=""
									class="k-content__head-breadcrumb-link">Layouts</a> <span
									class="k-content__head-breadcrumb-separator"></span> <a href=""
									class="k-content__head-breadcrumb-link">Basic</a>
						...
						<div class="row">
							<div class="col-lg-6">
								...
								<div class="k-portlet">
									<div class="k-portlet__head">
										<div class="k-portlet__head-label">
											<h3 class="k-portlet__head-title">Basic Form Layout</h3>
										</div>
									</div>
											...
											<div class="k-section k-section--first">
												...
												<div class="form-group">
													...
													<div class="k-checkbox-list">
														<label class="k-checkbox"> <input type="checkbox">
															Email <span></span>
														</label> <label class="k-checkbox"> <input type="checkbox">
															SMS <span></span>
														</label> <label class="k-checkbox"> <input type="checkbox">
															Phone <span></span>
														</label>
												...
												<div class="form-group row">
													<label class="col-form-label col-lg-3 col-sm-12">Multiple
														Select</label>
								...
								<div class="k-portlet">
									<div class="k-portlet__head">
										<div class="k-portlet__head-label">
											<h3 class="k-portlet__head-title">Section Separator</h3>
										</div>
									</div>
									...
									<form class="k-form">
										<div class="k-portlet__body">
											<div class="k-section k-section--first">
												...
												<div
													class="k-separator k-separator--border-dashed k-separator--space-lg k-separator--portlet-fit"></div>
												<div class="form-group">
													<label>Email address:</label> <input type="email"
														class="form-control" placeholder="Enter email"> <span
														class="form-text text-muted">We'll never share your
							...
							<div class="col-lg-6">
								...
								<div class="k-portlet">
									<div class="k-portlet__head">
										<div class="k-portlet__head-label">
											<h3 class="k-portlet__head-title">Horizontal Form Layout</h3>
										</div>
									</div>
									...
									<form class="k-form">
										<div class="k-portlet__body">
											<div class="k-section k-section--first">
												<h3 class="k-section__title">1. Customer Info:</h3>
												...
												<h3 class="k-section__title">2. Customer Account:</h3>
												<div class="k-section__body">
													<div class="form-group row">
														...
														<div class="col-lg-6">
															<div class="k-checkbox-inline">
																<label class="k-checkbox"> <input
																	type="checkbox"> Email <span></span>
																</label> <label class="k-checkbox"> <input
																	type="checkbox"> SMS <span></span>
																</label> <label class="k-checkbox"> <input
																	type="checkbox"> Phone <span></span>
																</label>
															</div>
														</div>
													</div>
	...
	<script
		src="${urlPublic}/assets/vendors/general/popper.js/dist/umd/popper.js"
		type="text/javascript"></script>
	<script
		src="${urlPublic}/assets/vendors/general/bootstrap/dist/js/bootstrap.min.js"
		type="text/javascript"></script>
	<script
		src="${urlPublic}/assets/vendors/general/js-cookie/src/js.cookie.js"
		type="text/javascript"></script>
	<script
		src="${urlPublic}/assets/vendors/general/moment/min/moment.min.js"
		type="text/javascript"></script>
	<script
	...
	<script
		...
		type="text/javascript"></script>
	<script
		src="${urlPublic}/assets/vendors/general/sticky-js/dist/sticky.min.js"
		type="text/javascript"></script>
	...
	<script
		...
		type="text/javascript"></script>
	<script
		src="${urlPublic}/assets/vendors/general/block-ui/jquery.blockUI.js"
		type="text/javascript"></script>
	<script
	...
	<script
		...
		type="text/javascript"></script>
	<script
		src="${urlPublic}/assets/vendors/custom/vendors/bootstrap-multiselectsplitter/bootstrap-multiselectsplitter.min.js"
		type="text/javascript"></script>
	<script
	...
	<script
		...
		type="text/javascript"></script>
	<script
		src="${urlPublic}/assets/vendors/general/handlebars/dist/handlebars.js"
		type="text/javascript"></script>
	<script
	...
	<script
		...
		type="text/javascript"></script>
	<script
		src="${urlPublic}/assets/vendors/general/autosize/dist/autosize.js"
		type="text/javascript"></script>
	<script
		src="${urlPublic}/assets/vendors/general/clipboard/dist/clipboard.min.js"
		type="text/javascript"></script>
	<script
		src="${urlPublic}/assets/vendors/general/dropzone/dist/dropzone.js"
		type="text/javascript"></script>
	<script
		src="${urlPublic}/assets/vendors/general/summernote/dist/summernote.js"
		type="text/javascript"></script>
	<script
		src="${urlPublic}/assets/vendors/general/markdown/lib/markdown.js"
		type="text/javascript"></script>
	<script
	...
	<script
		...
		type="text/javascript"></script>
	<script
		src="${urlPublic}/assets/vendors/general/toastr/build/toastr.min.js"
		type="text/javascript"></script>
	...
	<script src="${urlPublic}/assets/vendors/general/morris.js/morris.js"
		type="text/javascript"></script>
	<script
		src="${urlPublic}/assets/vendors/general/chart.js/dist/Chart.bundle.js"
		type="text/javascript"></script>
	<script
	...
	<script
		...
		type="text/javascript"></script>
	<script
		src="${urlPublic}/assets/vendors/general/counterup/jquery.counterup.js"
		type="text/javascript"></script>
	<script
	...
	<script
		...
		type="text/javascript"></script>
	<script
		src="${urlPublic}/assets/vendors/general/jquery.repeater/src/lib.js"
		type="text/javascript"></script>
	<script
		src="${urlPublic}/assets/vendors/general/jquery.repeater/src/jquery.input.js"
		type="text/javascript"></script>
	<script
		src="${urlPublic}/assets/vendors/general/jquery.repeater/src/repeater.js"
		type="text/javascript"></script>
	<script
		src="${urlPublic}/assets/vendors/general/dompurify/dist/purify.js"
		type="text/javascript"></script>
