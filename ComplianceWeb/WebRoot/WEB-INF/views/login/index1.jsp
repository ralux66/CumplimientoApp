...
<link href="${urlPublic}/assets/custom/user/login-v1.css"
...
<!-- begin::Body -->
<body
	style="background-image: url(${urlPublic}/assets/media/misc/bg_1.jpg)"
	class="k-login-v1--enabled k-header--fixed k-header-mobile--fixed k-aside--enabled k-aside--fixed">
			...
			<div class="k-grid__item  k-grid--hor">
				...
				<div class="k-login-v1__head">
					<div class="k-login-v1__head-logo">
						<a href="#"> <img
							src="${urlPublic}/assets/media/logos/logo-4.png" alt="" />
						</a>
					</div>
				...
				<div class="k-login-v1__body">
					...
					<div class="k-login-v1__body-wrapper">
						<div class="k-login-v1__body-container">
							<h3 class="k-login-v1__body-title">Sign To Account</h3>

							<!--begin::Form-->
							<form:form class="k-login-v1__body-form k-form"
								autocomplete="off" action="${urlForm}" method="POST"
								modelAttribute="user">
								<div class="form-group">
									<form:input class="form-control" type="text"
										placeholder="Username" path="codusr" autocomplete="off"></form:input>
								</div>
								<div class="form-group">
									<form:input class="form-control" type="password"
										placeholder="Password" path="password" autocomplete="off"></form:input>
								</div>
								<!--end::Form-->

								<!--begin::Action-->
								<div class="k-login-v1__body-action">
									<a href="#" class="k-link"> <span>Forgot Password ?</span>
									</a>
									<button type="submit" class="btn btn-pill btn-elevate">Sign
										In</button>
								</div>
							</form:form>
							<!--end::Action-->
							...
							<div class="k-login-v1__body-options">
								<a href="#" class="btn"> <i class="fab fa-facebook-f"></i>
									Fcebook
								</a> <a href="#" class="btn"> <i class="fab fa-twitter"></i>
									Twitter
								</a> <a href="#" class="btn"> <i class="fab fa-google"></i>
									Google
								</a>
							</div>
			...
			<div class="k-grid__item">
				<div class="k-login-v1__footer">
					<div class="k-login-v1__footer-link">
						<a href="#" class="k-link">Privacy</a> <a href="#" class="k-link">Legal</a>
	...
	<!--begin::Page Scripts -->
	<script
		src="${urlPublic}/assets/demo/default/custom/custom/login/login.js"
		type="text/javascript"></script>
