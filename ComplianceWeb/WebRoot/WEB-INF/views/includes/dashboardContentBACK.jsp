                        ...
                        <div class="k-subheader k-grid__item" id="k_subheader">
                            <div class="k-subheader__main">
                                ...
                                <div class="k-subheader__breadcrumbs">
                                    ...
                                    <span class="k-subheader__breadcrumbs-separator"></span> <a href="" class="k-subheader__breadcrumbs-link"> Dashboards </a> <span class="k-subheader__breadcrumbs-separator"></span> <a href="" class="k-subheader__breadcrumbs-link"> Navy Aside </a> 
                            ...
                            <div class="k-subheader__toolbar">
                                <div class="k-subheader__wrapper">
                                    ...
                                    <a href="#" class="btn btn-sm btn-elevate btn-brand btn-elevate" id="k_dashboard_daterangepicker" data-toggle="k-tooltip" title="" data-placement="left" data-original-title="Select dashboard daterange"> <span class="k-opacity-7" id="k_dashboard_daterangepicker_title">Today:</span>&nbsp; <span class="k-font-bold" id="k_dashboard_daterangepicker_date">Jan 11</span> <i class="flaticon-calendar-with-a-clock-time-tools k-padding-l-5 k-padding-r-0"></i> </a>
                                </div>
                            </div>
                        </div>
                        <!-- end:: Subheader -->
                                            ...
                                            <div class="k-widget-21">
                                                ...
                                                <div class="k-widget-21__data">
                                                    ...
                                                    <div class="k-widget-21__legends">
                                                        ...
                                                        <div class="k-widget-21__legend"> <i class="k-shape-bg-color-4"></i> <span>CSS</span> </div>
                                                        <div class="k-widget-21__legend"> <i class="k-shape-bg-color-3"></i> <span>Angular</span> </div>
                                                    </div>
                                            ...
                                            <div class="k-widget-9">
                                                <div class="k-widget-9__panel">
                                                    ...
                                                    <div class="k-widget-9__toolbar">
                                                        <div class="dropdown dropdown-inline">
                                                            <button type="button" class="btn btn-default dropdown-toggle btn-font-sm btn-bold btn-upper" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> August </button>
                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                <ul class="k-nav">
                                                                    <li class="k-nav__section k-nav__section--first"> <span class="k-nav__section-text">Export Tools</span> </li>
                                                                    <li class="k-nav__item">
