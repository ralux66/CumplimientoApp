			...
			<div class="dropdown dropdown-inline" data-toggle="k-tooltip"
				...
				<div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
					<ul class="k-nav k-nav--active-bg" role="tablist">
						<li class="k-nav__item"><a href="${urlRoot}client/newclient" class="k-nav__link"> <i
			...
			<div class="col k-align-right">
				<div class="k-section__content k-section__content--border">
					...
					<button type="button" class="btn btn-success k-btn"
						...
						Client</button>
					<!--begin::Modal-->
					<div class="modal fade  bd-example-modal-xl" id="exampleModal" role="dialog"
						aria-labelledby="" aria-hidden="true">
						<div class="modal-dialog modal-lg" role="document">
							<div class="modal-content">
								<div class="modal-header">
									<h5 class="modal-title" id="">New Modulo
									</h5>
											...
											<div class="modal-body">
												<div class="k-section__body">
													...
													<div class="form-group row">
														<label class="col-lg-3 col-form-label">Id Modulo:</label>
														<div class="col-lg-6">
															<form:input type="text" path="idmodulo"
																class="form-control" placeholder=""></form:input>
															<span class="form-text text-muted" required="required">Please
																enter your Id Module</span>
														</div>
													</div>
													<div class="form-group row">
													...
													<div class="form-group row">
														<label class="col-lg-3 col-form-label">Custom3:</label>
														<div class="col-lg-6">
															<form:input type="text" path="custom3"
																class="form-control" placeholder="" required="required"></form:input>
															<span class="form-text text-muted">Please enter
																your custom3</span>
														</div>
