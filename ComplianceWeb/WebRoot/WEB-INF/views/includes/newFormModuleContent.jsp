    ...
    <%@taglib uri="http://www.springframework.org/tags/form" prefix="form"%>
        <%@taglib uri="http://www.springframework.org/tags" prefix="spring"%>
            ...
            <div class="k-subheader k-grid__item" id="k_subheader">
                ...
                Extended </a> <span class="k-subheader__breadcrumbs-separator"></span> <a href="" class="k-subheader__breadcrumbs-link"> Formularios </a> <span class="k-subheader__breadcrumbs-separator"></span> <a href="" class="k-subheader__breadcrumbs-link">
                Widgets </a> <span class="k-subheader__breadcrumbs-separator"></span> <a href="" class="k-subheader__breadcrumbs-link"> Nuevo Modulo </a>
                                ...
                                <ul class="k-nav k-nav--active-bg" id="k_nav_1" role="tablist">
                                    ...
                                    <li class="k-nav__item">
                                        <a class="k-nav__link" role="tab" id="k_nav_link_1">
                                            <i class="k-nav__link-icon flaticon2-supermarket"></i> <span class="k-nav__link-text">Cliente</span>
                                            <span class="k-nav__link-badge"> <span
                                    ...
                                    <li class="k-nav__item">
                                        <a href="" class="k-nav__link"> <i class="k-nav__link-icon flaticon2-shopping-cart"></i>
                                            <span class="k-nav__link-text">Ordenes</span> </a>
                                    </li>
                                    <li class="k-nav__item">
                                        <a href="" class="k-nav__link"> <i class="k-nav__link-icon flaticon2-shopping-cart"></i>
                                            <span class="k-nav__link-text">Reportes</span> </a>
                                    </li>
                                    <li class="k-nav__item">
            ...
            <div class="k-content k-grid__item k-grid__item--fluid" id="k_content">
                ...
                <div class="k-portlet">
                    ...
                    <div class="k-portlet__body">
                        <form:form class="k-form k-form--label-right" modelAttribute="modulos" action="${urlForm}" method="POST">
                            <div class="modal-body">
                                <div class="k-section__body">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-lg-3 col-form-label">Codigo de Modulo:</label>
                                        <div class="col-lg-6">
                                            <form:input type="text" path="idmodulo" class="form-control" placeholder="">
                                            </form:input>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <span class="form-text text-muted">Favor ingrese el Nombre del Module</span>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <span class="form-text text-muted">Favor ingrese su Description</span>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <span class="form-text text-muted">PFavor ingrese su Opcional 1</span>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-lg-3 col-form-label">Opcional 3:</label>
                                        <div class="col-lg-6">
                                            <form:input type="text" path="custom3" class="form-control" placeholder="" required="required"></form:input>
                                            <span class="form-text text-muted">Favor ingrese su Opcional 3</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
