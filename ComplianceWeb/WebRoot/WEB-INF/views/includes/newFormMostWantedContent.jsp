   ...
   <div class="k-portlet">
      ...
      <div class="k-portlet__body">
         <form:form class="k-form k-form--label-right"
            modelAttribute="mostwanted" action="${urlForm}" method="POST">
               ...
               <div class="k-section__body">
                  ...
                  <div class="form-group row">
                     ...
                     <div class="col-lg-6">
                        ...
                        <span class="form-text text-muted" required="required">Nombre Completo</span>
                     </div>
                  </div>
                  <div class="form-group row">
                     <label class="col-lg-3 col-form-label">primerNombre:</label>
                     <div class="col-lg-6">
                        <form:input type="text" path="primerNombre"
                           class="form-control" placeholder="" required="required"></form:input>
                        <span class="form-text text-muted">primerNombre</span>
                     </div>
                  </div>
                  <div class="form-group row">
                     <label class="col-lg-3 col-form-label">segundoNombre:</label>
                     <div class="col-lg-6">
                        <form:input type="text" path="segundoNombre"
                           class="form-control" placeholder="" required="required"></form:input>
                        <span class="form-text text-muted">segundoNombre</span>
                     </div>
                  </div>
                  <div class="form-group row">
                     <label class="col-lg-3 col-form-label">primerApellido:</label>
                     <div class="col-lg-6">
                        <form:input type="text" path="primerApellido"
                           class="form-control" placeholder="" required="required"></form:input>
                        <span class="form-text text-muted">primerApellido</span>
                     </div>
                  </div>
                  <div class="form-group row">
                     <label class="col-lg-3 col-form-label">segundoApellido:</label>
                     <div class="col-lg-6">
                        <form:input type="text" path="segundoApellido"
                           class="form-control" placeholder="" required="required"></form:input>
                        <span class="form-text text-muted">segundoApellido</span>
                     </div>
                  </div>
                  <div class="form-group row">
                     <label class="col-lg-3 col-form-label">apellidoCasada:</label>
                     <div class="col-lg-6">
                        <form:input type="text" path="apellidoCasada"
                           class="form-control" placeholder="" required="required"></form:input>
                        <span class="form-text text-muted">apellidoCasada</span>
                     </div>
                  </div>
                  <div class="form-group row">
                     <label class="col-lg-3 col-form-label">alias:</label>
                     <div class="col-lg-6">
                        <form:input type="text" path="alias"
                           class="form-control" placeholder=""></form:input>
                        <span class="form-text text-muted">alias</span>
                     </div>
                  </div>
                  <div class="form-group row">
                     <label class="col-lg-3 col-form-label">delito:</label>
                     <div class="col-lg-6">
                        <form:input type="text" path="delito"
                           class="form-control" placeholder=""></form:input>
                        <span class="form-text text-muted">delito</span>
                     </div>
                  </div>
                  <div class="form-group row">
                     <label class="col-lg-3 col-form-label">residencia:</label>
                     <div class="col-lg-6">
                        <form:input type="text" path="residencia"
                           class="form-control" placeholder=""></form:input>
                        <span class="form-text text-muted">residencia</span>
                     </div>
                  </div>
                  <div class="form-group row">
