...
<spring:url value="/notario-auto/gosearch" var="urlForm" />
<!-- begin:: Subheader -->
				...
				<div class="k-portlet__head">
					<div class="k-portlet__head-label">
						<h3 class="k-portlet__head-title">
							Busqueda Notarios <small>verificacion</small>
						</h3>
					</div>
					<div class="k-portlet__head-toolbar">
						<ul
							...
							role="tablist">
							<li class="nav-item">
								<a class="nav-link active" data-toggle="tab" href="#k_portlet_tabs_1_1_content" role="tab">	Busqueda Notarios </a>
							</li>
						</ul>
					</div>
				</div>
							 ...
							 <table
								...
								<tbody>
									<c:forEach var="allResultreturn" items="${allResultreturn}"
										varStatus="loop">
										<tr>										
											<td>${allResultreturn.nombres}</td>
											<td>${allResultreturn.titulo}</td>
											<td>${allResultreturn.institucion}</td>
											<td>${allResultreturn.fechaActualizacion}</td>											
