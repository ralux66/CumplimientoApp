			...
			<div class="dropdown dropdown-inline" data-toggle="k-tooltip"
				...
				<div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
					<ul class="k-nav k-nav--active-bg" role="tablist">
						<li class="k-nav__item"><a href="${urlRoot}peps/listapeps"
							class="k-nav__link"> <i
	...
	<div class="k-portlet">
		<div class="k-portlet__head">
			<div class="k-portlet__head-label">
				<h3 class="k-portlet__head-title">New Peps</h3>
			</div>
		</div>
		<!--begin::Form-->
		<div class="k-portlet__body">
			<form:form class="k-form k-form--label-right" modelAttribute="peps"
				...
				<div class="modal-body">
					<div class="k-section__body">
						...
						<div class="form-group row">
							...
							<div class="col-lg-6">
								<form:input type="text" path="institucion" class="form-control"
						...
						<div class="form-group row">
							...
							<div class="col-lg-6">
								<form:input type="text" path="funcionario" class="form-control"
									placeholder="" required="required"></form:input>
								<span class="form-text text-muted">Please enter your
									funcionario</span>
							</div>
