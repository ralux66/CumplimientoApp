...
<spring:url value="/menciones/gosearch" var="urlForm" />
<!-- begin:: Subheader -->
									...
									<div class="input-group">
										<div class="input-group-prepend">
											<button type="button"
												...
												aria-expanded="false">Menciones</button>
										</div>
								...
								<div class="tab-content">
									<div class="tab-pane active"
										...
										<table
											...
											<tbody>
												<c:forEach var="AllResultreturn" items="${listamenciones}"
													varStatus="loop">
													<tr>
														<td>${AllResultreturn.abstracts}</td>
														<td>${AllResultreturn.metadata}</td>
														<td><a href="${AllResultreturn.url}" target="_blank">${AllResultreturn.url}</a></td>
													</tr>
												</c:forEach>
											</tbody>
										</table>
