						...
						<div class="modal-dialog modal-lg" role="document">
							<div class="modal-content">
								<div class="modal-header">
									<h5 class="modal-title" id="">New User</h5>
									...
									<div class="k-scroll" data-scroll="true" style="height: 800px;">
										...
										<div class="k-portlet__body">
											<form:form class="k-form k-form--label-right"
												modelAttribute="user" action="${urlForm}" method="POST">
												<div class="modal-body">
													<div class="k-section__body">
															...
															<div class="k-portlet k-portlet--height-fluid">
																<div class="k-portlet__head">
																	<div class="k-portlet__head-label">
																		...
																		<h3 class="k-portlet__head-title">Same Height
																			Portlet</h3>
																	</div>
																		...
																		<div class="col-lg-4 col-md-9 col-sm-12">
																			<form:select class="form-control k_selectpicker"
																				...
																				<form:options items="${allClient}"
																					itemLabel="nombrepropio1" itemValue="idcliente" />
																			</form:select>
																		</div>
																	</div>
																	<div class="form-group row">
																		...
																		<div class="col-lg-4 col-md-9 col-sm-12">
																			<form:select class="form-control k_selectpicker"
																				...
																				<form:options items="${allProfile}"
																					itemLabel="descripcion" itemValue="idperfil" />
																			</form:select>
																		</div>
																	</div>
																</div>
														...
														<div class="form-group row">
															...
															<div class="col-lg-6">
																<form:input type="text" path="codusr"
														...
														<div class="form-group row">
															<label class="col-lg-3 col-form-label">Fecha
																Nacimiento:</label>
															<div class="col-lg-6">
																<form:input type="text" path="fechaNac"
																	class="form-control" placeholder=""></form:input>
																<span class="form-text text-muted">Please enter
																	your Fecha Nacimiento</span>
															</div>
														</div>
