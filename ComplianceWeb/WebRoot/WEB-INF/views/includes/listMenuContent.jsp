                    ...
                    <div class="k-portlet__foot">
                        <div class="col k-align-right">
                            <div class="k-section__content k-section__content--border">
                                ...
                                <button type="button" class="btn btn-success k-btn" data-toggle="modal" data-target="#exampleModal">Nuevo Menu</button>
                                <!--begin::Modal-->
                                <div class="modal fade  bd-example-modal-xl" id="exampleModal" role="dialog" aria-labelledby="" aria-hidden="true">
                                    <div class="modal-dialog modal-lg" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="">Nuevo Menu</h5>
                                                    ...
                                                    <form:form class="k-form k-form--label-right" modelAttribute="menu" action="${urlForm}" method="POST">
                                                        <div class="modal-body">
                                                            ...
                                                            Configuracion</label>
                                                                ...
                                                                <div class="form-group row">
                                                                    <label class="col-lg-3 col-form-label">codigo menu:</label>
                                                                    <div class="col-lg-6">
                                                                ...
                                                                ingrese el codigo de menu</span>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group row">
                                                                    <label class="col-lg-3 col-form-label">nombre menu:</label>
                                                                    <div class="col-lg-6">
                                                                        <form:input type="text" path="nombremenu" class="form-control" placeholder="" required="required">
                                                                        </form:input>
                                                                        <span class="form-text text-muted">Favor ingrese el nombre
                                                                de menu</span>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <form:input type="text" path="observacion" class="form-control" placeholder="" required="required">
                                                                        </form:input>
                                                                ...
                                                                <div class="form-group row">
                                                                    <label class="col-lg-3 col-form-label">Opcional1:</label>
                                                                    <div class="col-lg-6">
                                                                ...
                                                                el valor opcional1</span>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group row">
                                                                    <label class="col-lg-3 col-form-label">Opcional2:</label>
                                                                    <div class="col-lg-6">
                                                                        <form:input type="text" path="custom2" class="form-control" placeholder="" required="required"></form:input>
                                                                        <span class="form-text text-muted">Favor ingrese
                                                                el valor opcional2</span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
