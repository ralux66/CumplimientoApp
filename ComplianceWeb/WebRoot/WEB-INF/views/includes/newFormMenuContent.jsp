	...
	<div class="k-portlet">
		<div class="k-portlet__head">
			<div class="k-portlet__head-label">
				<h3 class="k-portlet__head-title">New Menu</h3>
			</div>
		</div>
		<!--begin::Form-->
		<div class="k-portlet__body">
			<form:form class="k-form k-form--label-right" modelAttribute="menu"
				...
				<div class="modal-body">
					<div class="k-section__body">
						...
						<div class="form-group row">
							...
							<div class="col-lg-6">
								<form:input type="text" path="nombremenu" class="form-control"
						...
						<div class="form-group row">
							...
							<div class="col-lg-6">
								<form:input type="text" path="custom2"
									class="form-control" placeholder="" required="required"></form:input>
								<span class="form-text text-muted">Please enter your custom2</span>
							</div>
						</div>						
					</div>
				</div>
