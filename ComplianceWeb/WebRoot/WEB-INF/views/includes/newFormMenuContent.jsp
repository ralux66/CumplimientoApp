        ...
        <%@taglib uri="http://www.springframework.org/tags" prefix="spring"%>
            ...
            <div class="k-subheader k-grid__item" id="k_subheader">
                <div class="k-subheader__main">
                    <h3 class="k-subheader__title">Nuevo Menu</h3>
				...
				Extended </a> <span class="k-subheader__breadcrumbs-separator"></span> <a href="" class="k-subheader__breadcrumbs-link"> Forms </a> <span class="k-subheader__breadcrumbs-separator"></span> <a href="" class="k-subheader__breadcrumbs-link">
				Widgets </a> <span class="k-subheader__breadcrumbs-separator"></span> <a href="" class="k-subheader__breadcrumbs-link"> Nuevo Menu </a>
                ...
                <div class="k-portlet">
                    <div class="k-portlet__head">
                        <div class="k-portlet__head-label">
                            <h3 class="k-portlet__head-title">Nuevo Menu</h3>
                        </div>
                    </div>
                    <!--begin::Form-->
                            ...
                            <div class="modal-body">
                                <div class="k-section__body">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-form-label col-lg-3 col-sm-12">Configuracion del Modulo
							</label>
                                        <div class="col-lg-4 col-md-9 col-sm-12">
                                            <form:select class="form-control k_selectpicker" path="idmodulo.idmodulo" id="idmodulo">
                                                <form:options items="${moduloLista}" itemLabel="nombre" itemValue="idmodulo" />
                                            </form:select>
                                        </div>
                                    </div>

                                    <div class="form-group row">
                                        <label class="col-lg-3 col-form-label">Codigo del Menu:</label>
                                        <div class="col-lg-6">
                                            <form:input type="text" path="codmenu" class="form-control" placeholder=""></form:input>
                                            <span class="form-text text-muted" required="required">Favor ingrese su codigo del
									menu</span>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-lg-3 col-form-label">Nombre del Menu:</label>
                                        <div class="col-lg-6">
                                            <form:input type="text" path="nombremenu" class="form-control" placeholder="" required="required"></form:input>
                                            <span class="form-text text-muted">Favor ingrese su nombre del menu</span>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <span class="form-text text-muted">Favor ingrese su observacion</span>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-lg-3 col-form-label">Opcional 1</label>
                                        <div class="col-lg-6">
                                            <form:input type="text" path="custom1" class="form-control" placeholder="" required="required"></form:input>
                                            <span class="form-text text-muted">Favor ingrese su opcional 1</span>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-lg-3 col-form-label">Opcional 2:</label>
                                        <div class="col-lg-6">
                                            <form:input type="text" path="custom2" class="form-control" placeholder="" required="required"></form:input>
                                            <span class="form-text text-muted">Favor ingrese su opcional 2</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
