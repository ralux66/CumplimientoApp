	...
	<div class="k-subheader__main">
		...
		<div class="k-subheader__breadcrumbs">
			<a href="#" class="k-subheader__breadcrumbs-home"><i
				...
				class="k-subheader__breadcrumbs-link"> Extendida </a> <span
				class="k-subheader__breadcrumbs-separator"></span> <a href=""
				class="k-subheader__breadcrumbs-link"> Formularios </a> <span
				class="k-subheader__breadcrumbs-separator"></span> <a href=""
				class="k-subheader__breadcrumbs-link"> Controles </a> <span
				class="k-subheader__breadcrumbs-separator"></span> <a href=""
				class="k-subheader__breadcrumbs-link"> Groupos de Entrada </a>
							...
							<form method="POST" class="k-form k-form--label-right"
								...
								<div class="form-group ">
									...
									<span class="form-text text-muted"> <span
										class="form-text text-muted">Digite el nombre que va a
											buscar</span>
									</span>
								</div>
							</form>
								...
								<div class="k-portlet__head-toolbar">
									<ul
										...
										<li class="nav-item"><a class="nav-link active"
											...
											role="tab"> Resultado de la busqueda </a></li>
									</ul>
								</div>
							</div>
							<div class="k-portlet__body">
												...
												<c:forEach var="AllResultreturn" items="${AllResultreturn}"
													...
													<tr>
														...
														<td><fmt:formatNumber type="percent"
																maxFractionDigits="3" value="${AllResultreturn.score}" />
														</td>
													</tr>
												</c:forEach>
												<c:forEach var="AllResultreturnfuncionarios"
													items="${AllResultreturnfuncionarios}" varStatus="loop">
													<tr>
														<td>${AllResultreturnfuncionarios.institutionId}</td>
														<td>${AllResultreturnfuncionarios.name}</td>
														<td>${AllResultreturnfuncionarios.name}</td>
														<td>-</td>
														<td>-</td>
														<td>${AllResultreturnfuncionarios.position}</td>
														<td>${AllResultreturnfuncionarios.createdAt}</td>
														<td>${AllResultreturnfuncionarios.updatedAt}</td>
														<td><fmt:formatNumber type="percent"
																maxFractionDigits="3"
																value="${AllResultreturnfuncionarios.score}" /></td>
