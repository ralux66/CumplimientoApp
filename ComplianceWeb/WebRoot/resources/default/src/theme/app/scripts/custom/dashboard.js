...
var KDashboard = function() {
    ...
    var mediumCharts = function() {
        ...
        KLib.initMediumChart('k_widget_mini_chart_2', [10, 15, 25, 45, 15, 30, 10, 40, 15, 25], 70, KApp.getColor('brand'));
    ...
    var latestProductsMiniCharts = function() {
        KLib.initMiniChart($('#k_widget_latest_products_chart_1'), [6, 12, 9, 18, 15, 9, 11, 8], KApp.getColor('info'), 2);
        KLib.initMiniChart($('#k_widget_latest_products_chart_2'), [8, 6, 13, 16, 9, 6, 11, 14], KApp.getColor('warning'), 2);
        KLib.initMiniChart($('#k_widget_latest_products_chart_3'), [8, 6, 13, 16, 9, 6, 11, 14], KApp.getColor('warning'), 2);
        KLib.initMiniChart($('#k_widget_latest_products_chart_4'), [3, 9, 9, 18, 15, 9, 11, 8], KApp.getColor('success'), 2);
        KLib.initMiniChart($('#k_widget_latest_products_chart_5'), [5, 7, 9, 18, 15, 9, 11, 8], KApp.getColor('brand'), 2);
        KLib.initMiniChart($('#k_widget_latest_products_chart_6'), [3, 9, 5, 18, 15, 7, 11, 6], KApp.getColor('danger'), 2);
    }

    var generalStatistics = function() {
        // Mini charts
        KLib.initMiniChart($('#k_widget_general_statistics_chart_1'), [6, 8, 3, 18, 15, 7, 11, 7], KApp.getColor('warning'), 2);
        KLib.initMiniChart($('#k_widget_general_statistics_chart_2'), [8, 6, 9, 18, 15, 7, 11, 16], KApp.getColor('brand'), 2);
        KLib.initMiniChart($('#k_widget_general_statistics_chart_3'), [4, 12, 9, 18, 15, 7, 11, 12], KApp.getColor('danger'), 2);
        KLib.initMiniChart($('#k_widget_general_statistics_chart_4'), [3, 14, 5, 12, 15, 8, 14, 16], KApp.getColor('success'), 2);
    ...
    var widgetTotalOrdersChart = function() {
        // filled charts
        KLib.initMiniChart($('#k_widget_total_orders_chart'), [0, 1, 3, 8, 4, 3, 5, 10, 4, 0], KApp.getColor('danger'), 2, true, true);
    }        
